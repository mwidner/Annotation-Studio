...
Annotator.Plugin.Share = (function(_super) {
	...
	Share.prototype.pluginInit = function() {
		...
		var newfield = Annotator.$('<li class="annotator-item">'+this.buildHTML('Share:')+'</li>');
	...
	Share.prototype.buttonsActions = function(field,method) {
		...
		$(field).find('.share-email-annotator').click(function() {
			var url = share.createAPIURL(method),
				subject = "Sharing an annotation with Annotation Studio";
				body = encodeURIComponent(url);
			
			window.open('mailto:?subject='+subject+'&body='+body, '_parent');
		});
		$(field).find('.share-facebook-annotator').click(function() {
			var url = share.createAPIURL(method),
				fbURL = 'https://www.facebook.com/sharer/sharer.php?s=100&p[url]='+encodeURIComponent(url)+'&p[title]='+encodeURIComponent('Annotation Studio')+'&p[summary]='+share.getSource('ovaText');
			
			window.open(fbURL);
		});
		$(field).find('.share-twitter-annotator').click(function() {
			var url = share.createAPIURL(method),
				twitterURL = 'https://twitter.com/intent/tweet?original_referer='+encodeURIComponent(url)+'&source=tweetbutton&url='+encodeURIComponent(url)+"&via=MIThyperstudio&text="+encodeURIComponent('Sharing this annotation: ');
